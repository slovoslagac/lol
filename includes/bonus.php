...
FROM statisticsmain JOIN users ON statisticsmain.UserID=users.Id WHERE MONTH(statisticsmain.StartDateTime) = :mt GROUP BY statisticsmain.UserID ORDER BY this_month DESC, statisticsmain.TotalMinutes desc, Username limit :lt");
