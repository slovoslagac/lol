  ...
  <div class="subnavbar-inner">
    <div class="container">
      <ul class="mainnav">
        ...
        <li class="active"><a href="kraj_smene.php"><i class="icon-list-alt"></i><span>Kraj smene</span> </a> </li>
      ...
      <div class="row">
        <div class="span6">
            ...
            <div class="widget-header"> <i class="icon-time"></i>
                <h3>26.03.2017. - Druga smena - Stefan - Pazar</h3>
            </div>
            <!-- /widget-header -->
            ...
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                  <tr>
                    ...
                    <td> <input type="number" id="money" name="money" value="" placeholder="Ukupan iznos novca u kasi" class="pazar" /> </td>
                    <td></td>  
                  </tr>
                    <tr>
                    <td> Depozit </td>
                    ...
                    <tr>
                    <td> Dugovi </td>
                    <td> <input type="number" id="money" name="money" value="" placeholder="Nova zaduženja" class="pazar" /> </td>
                    <td></td>  
                  </tr>
                    <tr>
                    <td> Vraćeni dugovi </td>
                    <td> <input type="number" id="money" name="money" value="" placeholder="Vraćeni dugovi" class="pazar" /> </td>
                    <td></td>  
                  </tr>
                    <tr>
                    <td> Ostalo </td>
                    <td> <input type="number" id="money" name="money" value="" placeholder="Ostali troškovi" class="pazar" /> </td>
                    <td></td>  
                  </tr>
                  <tr>
