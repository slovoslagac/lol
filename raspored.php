      ...
      <div class="row">
        <div class="span12">
            ...
            <div class="widget-header"> <i class="icon-calendar"></i>
                <h3>Raspored 27.03. - 02.04. <a href="#back"><i class="icon-chevron-left"></i></a> <a href="#next"><i class="icon-chevron-right"></i></a></h3>
            </div>
            <!-- /widget-header -->
            ...
            <table class="table table-striped table-bordered">
                <thead>
                  <tr>
                    <th class="center"> PON 27.03. </th>
                    <th class="center"> UTO 28.03. </th>
                      <th class="center"> SRE 29.03. </th>
                      <th class="center"> ČET 30.03. </th>
                      <th class="center"> PET 31.03. </th>
                      <th class="center"> SUB 01.04. </th>
                      <th class="center"> NED 02.04. </th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    <td class="center"> Stefan </td>
                    <td class="center"> Sofija </td>
                    <td class="center"> Nikola </td>
                    <td class="center"> Mihajlo </td>
                    <td class="center"> Stefan </td>
                    <td class="center"> Sofija </td>
                    <td class="center"> Nikola </td>
                  </tr>
